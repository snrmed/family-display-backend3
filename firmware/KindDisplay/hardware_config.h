...
// Supports: Original ESP32 dev board, reTerminal E1002, XIAO ePaper EE04
...
// Auto-detect device if not manually specified
#if !defined(DEVICE_RETERMINAL_E1002) && !defined(DEVICE_XIAO_EE04) && !defined(DEVICE_ORIGINAL_ESP32)
  // Auto-detection logic based on ESP32 variant
    ...
    #define DEVICE_RETERMINAL_E1002
  #else
    // ESP32 classic - original hardware
    #define DEVICE_ORIGINAL_ESP32
  #endif
#endif
